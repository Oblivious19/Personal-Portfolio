...
<footer
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> shreyaojha2@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/Oblivious19 " target="_blank" class="text-violet-400"
                >Oblivious19<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/shreya-ojha-a9548a218/ " target="_blank" class="text-violet-400"
                >shreyaojha19<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
